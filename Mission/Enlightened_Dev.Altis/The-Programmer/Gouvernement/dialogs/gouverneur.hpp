...
class maxence_gouverneur {
   ...
   class controls
   {
       ...
       class emploiministre : Life_RscButtonInvisible_Governement
       {
       ...
       class exclureministre : Life_RscButtonInvisible_Governement
       {
       ...
       class employersecurite : Life_RscButtonInvisible_Governement
       {
       ...
       class excluresecurite : Life_RscButtonInvisible_Governement
       {
       ...
       class closeButton : Life_RscButtonInvisible_Governement
       {
       ...
       class transfert : Life_RscButtonInvisible_Governement
       {
           x = 0.5984375 * safezoneW + safezoneX;
       ...
       class historique : Life_RscButtonInvisible_Governement
       {
       ...
       class editlaws : Life_RscButtonInvisible_Governement
       {
           x = 0.5984375 * safezoneW + safezoneX;
